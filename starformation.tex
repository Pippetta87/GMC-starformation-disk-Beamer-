...
If $v(l_s)=c_s$: $\lambda_{mfp}\approx\SI{e13}{\cm}$, $l_s\approx\SI{0.03}{\pc}$, $l_{\nu}\approx\SI{3e-5}{\pc}$: density perturbation in non magnetic GMC with characteristic lenght $l_s$ will have order unity amplitude.
\end{column}\begin{column}{0.5\textwidth}
...
\[l_{AD}=\frac{v_A}{n_i\alpha_{in}}\approx\SI{0.5}{\pc}(\frac{v_A}{\SI{3}{\kilo\meter\per\second}})(\frac{n_i}{\SI{e-3}{\per\cubic\cm}})\expy{-1}.
