...
\end{column}\end{columns}
\begin{figure}
\includegraphics[trim={0cm 0cm 0 0},clip, keepaspectratio,width=0.45\textwidth]{polyadimprofile}
\includegraphics[trim={0cm 0 0 0},clip,width=0.45\textwidth]{polyadimmassvsdcontr}
\end{figure}
\end{frame}
