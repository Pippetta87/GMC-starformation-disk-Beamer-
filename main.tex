...
\begin{frame}[allowframebreaks]{Indice}\phantomsection\linkdest{intro}
...
\part{GMC e formazione stellare}\linkdest{part:GMC}
%\input{starformation}

\part{Accrescimento e dischi protoplanetarii}\linkdest{part:accretionanddisks}
\input{disks}
